...
<script src="./HomePage.ts" module lang="ts"></script>

<template>
  <div class="homePage">
    <div class="header">
      <!-- make header a seperate component later -->
      ...
      <div class="headerMenu">
        ...
        <a href="/" class="titleStyle" data-marker="main-menu/exploreLink">Following</a>
        <a href="/" class="titleStyle" data-marker="main-menu/exploreLink">Activity</a>
      </div>
      ...
      <div class="headerMenu">
        ...
        <div class="headerDropDownBtn">
          ...
          >
            ...
            <b-dropdown-item href="#">RARI Token</b-dropdown-item>
            <b-dropdown-item href="#">Discussion</b-dropdown-item>
            <b-dropdown-item href="#">Voting</b-dropdown-item>
            <b-dropdown-item href="#">Suggest feature</b-dropdown-item>
            <b-dropdown-item href="#">Subscribe</b-dropdown-item>
            <b-dropdown-divider></b-dropdown-divider>

            <b-dropdown-item href="#">
              <div class="sc-bdnxRM sc-oeezt sc-hhIiOg jvCTkj cPyZzU kIqILL">
                <div class="sc-bdnxRM sc-gtsrHT jvCTkj cpCbhi">
                  <a
      ...
      <!-- <div>
        <b-dropdown size="lg" variant="link" toggle-class="text-decoration-none" style="color:gray">
          <template #button-content> <span class="caret"></span> </template>
        ...
        <div class="displayFlex">
          <div class="buttonWrap">
            <button
              ...
              type="button"
              data-marker="root/appPage/header/createCollectibleButton"
            >
              Create
            </button>
      ...
      <div class="description descriptionFloatRight">
        <div class="descriptionMarginTop">
          <div>
                  ...
                  <div class="descriptionDetailsTitleLikes">
                    ...
                    <div>
                      <b-dropdown
                        ...
                        class="m-md-3"
                        no-caret
                        toggle-class="rounded-circle bold"
                      >
                        <b-dropdown-item class="dropDownItem">New bid</b-dropdown-item>
                        <b-dropdown-item>Purchase now</b-dropdown-item>
                        <b-dropdown-item>Third Action</b-dropdown-item>
                        <b-dropdown-divider></b-dropdown-divider>
                        <b-dropdown-item>View on OpenSea</b-dropdown-item>
            ...
            <div class="descriptionTextPadding paragraphTextWrap">
            ...
            <div class="bubbleNoticeBar">
                      ...
                      >
                        ...
                        <div role="tablist" class="displayFlex descriptionDetailsTitleAlign">
                          <button
                            ...
                            class="descriptionDetailsTextBtnStyle"
                          >
                            <span v-if="selectedTab=='Details'" class="descriptionDetailsText descriptionDetailsTextPadding">Details</span>
                            <span v-else-if="selectedTab!=='Details'" class="descriptionDetailsText descriptionDetailsUnselectedMenu">Details</span>
                            <div class="displayFlex descriptionDetailsTextStyle"></div>
                          </button>

                          <button
                            v-on:click="changeTab('Bids')"
                            role="tab"
                            aria-selected="false"
                            type="button"
                            ...
                            class="descriptionDetailsTextBtnStyle "
                          >
                            <span v-if="selectedTab=='Bids'"  class="descriptionDetailsText descriptionDetailsTextPadding">Bids</span>
                            <span v-else-if="selectedTab!=='Bids'"  class="descriptionDetailsText descriptionDetailsUnselectedMenu">Bids</span>
                          ...
                          >
                            <span v-if="selectedTab=='History'" class="descriptionDetailsText descriptionDetailsTextPadding">History</span>
                            <span v-else-if="selectedTab!=='History'" class="descriptionDetailsText descriptionDetailsUnselectedMenu">History</span>
                            <div class="displayFlex"></div>
                          </button>
                        </div>
                      </div>
              ...
              <div class="descriptionDetailsPadding" v-if="selectedTab == 'Bids'">
                <div class="bidSecStyle">
                  <span class="bidImageStyle"
                    ><svg
                      viewBox="0 0 12 16"
                      fill="none"
                      width="38"
                    ...
                    >
                      <path
                        ...
                        fill="currentColor"
                      ></path></svg></span
                  ><span class="bidsTextStyle"
                    >No active bids yet. Be the first to make a bid!</span
                  >
                </div>
              </div>

              <div class="descriptionDetailsPadding" v-if="selectedTab == 'History'">
                History 
                
              </div>

              <div class="descriptionDetailsPadding" v-if="selectedTab == 'Details'">
                <div>
                  <div class="displayFlex">
